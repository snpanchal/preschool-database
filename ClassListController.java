...
public class ClassListController extends SwitchScenes {
	...
	public ObservableList<Student> getStudents(String className) throws SQLException, ClassNotFoundException {
        ObservableList<Student> students = FXCollections.observableArrayList();
        ResultSet rs = DatabaseOperations.getClassList(className);
        while (rs.next()) {
	...
	public void populateStudentTable() {
        ...
        try {
            studentTable.setItems(getStudents(className));
